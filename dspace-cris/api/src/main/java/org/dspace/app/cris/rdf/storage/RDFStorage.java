...
public interface RDFStorage {
     ...
     * {@link org.dspace.app.cris.rdf.RDFizer#convert(org.dspace.core.Context, 
     * org.dspace.content.DSpaceObject) RDFizer.convert(...)} to convert and store DSpaceObjets.
     * @param uri Identifier for this DSO 
     * ({@link org.dspace.app.cris.rdf.RDFizer#generateIdentifier(org.dspace.core.Context, 
    ...
    /**
     * Don't use this method directly, use
     * {@link org.dspace.app.cris.rdf.RDFizer#loadModel(String) RDFizer.loadModel(...)} instead.
     * @param uri
     * @return 
     */
